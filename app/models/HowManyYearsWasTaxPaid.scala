...
sealed trait HowManyYearsWasTaxPaid

object HowManyYearsWasTaxPaid {
  ...
  val options: Set[RadioOption] = values.map {
    value =>
      RadioOption("howManyYearsWasTaxPaid", value.toString)
  }

  implicit val enumerable: Enumerable[HowManyYearsWasTaxPaid] =
