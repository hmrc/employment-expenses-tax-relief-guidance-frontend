...
claimingFor.homeWorking.description = You can only claim for extra household costs such as business phone calls, gas and electricity for the room you work in. You cannot claim for things that you use for both private and work purposes such as rent, broadband, equipment or furniture._CY //TODO update welsh
...
disclaimer.claim.after.insetText = You must send HMRC evidence to show why you get tax relief. You must print and post a completed form to HMRC to claim on your expenses._CY //TODO update welsh
...
disclaimer.claim.before.insetText = If you worked from home because of government guidelines, you do not need to give evidence of this._CY //TODO update welsh
...
informCustomerClaimNowInWeeks.para2 = Os nad ydych yn siŵr sawl wythnos y byddwch yn gymwys i hawlio ar eu cyfer, rydym yn eich cynghori i aros hyd nes eich bod yn gwybod. Mae hyn oherwydd nad oes modd gwneud unrhyw newidiadau pellach gan ddefnyddio’r gwasanaeth hwn ac efallai y bydd yn cymryd mwy o amser i brosesu.
informCustomerClaimNowInWeeks.para2_new = Os nad ydych yn siŵr faint o wythnosau y byddwch yn gymwys i hawlio ar eu cyfer, rydym yn eich cynghori i aros hyd nes eich bod yn gwybod, oherwydd gall unrhyw newidiadau pellach cymryd mwy o amser i brosesu.
