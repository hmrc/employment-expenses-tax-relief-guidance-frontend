...
usePrintAndPostDetailed.title_freOnly = Gallwch wneud hawliad am y treuliau swydd hyn
usePrintAndPostDetailed.heading = Rydych yn gymwys i hawlio’r treuliau swydd hyn
usePrintAndPostDetailed.heading_freOnly = Gallwch wneud hawliad am y treuliau swydd hyn
...
usePrintAndPostDetailed.para1_freOnly = Cyn anfon eich hawliad, gwiriwch yr arweiniad isod ynghylch pob math o draul wahanol. I hawlio’r treuliau hyn, mewngofnodwch i lenwi ffurflen ar-lein.
usePrintAndPostDetailed.para2_freOnly = Os na allwch hawlio ar-lein, gallwch wneud
usePrintAndPostDetailed.para2_freOnly.link.label = hawliad drwy’r post (yn agor ffenestr neu dab newydd)
...
usePrintAndPostDetailed.uniformsClothingTools.1_freOnly = Os ydych yn hawlio swm sefydlog o ryddhad treth, ni fydd angen i chi anfon derbynebau na chofnodion.
...
usePrintAndPostDetailed.mileageFuel.1_freOnly = Mae’n rhaid i chi anfon copi o’ch cofnod milltiroedd at CThEF ar gyfer pob swydd. Dylai hwn ddangos pam y gwnaethoch bob taith, a dylai nodi cod post ar gyfer dechrau a diwedd y daith.
usePrintAndPostDetailed.mileageFuel.2_freOnly = Os nad yw’ch cyflogwr wedi’ch talu chi yn ôl am unrhyw filltiroedd neu gostau teithio, bydd angen i chi anfon llythyr yn esbonio pam.
...
usePrintAndPostDetailed.link.label_freOnly = Dechrau’ch hawliad
