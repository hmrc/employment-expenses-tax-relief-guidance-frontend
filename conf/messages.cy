...
usePrintAndPostDetailed.title_freOnly = You can make a claim for these job expenses_CY
usePrintAndPostDetailed.heading = Rydych yn gymwys i hawlio’r treuliau swydd hyn
usePrintAndPostDetailed.heading_freOnly = You can make a claim for these job expenses_CY
...
usePrintAndPostDetailed.para1_freOnly = Before sending your claim, check the guidance below for each type of expense. To claim these expenses, sign in to complete an online form._CY
usePrintAndPostDetailed.para2_freOnly = If you cannot claim online, you can make a_CY
usePrintAndPostDetailed.para2_freOnly.link.label = claim by post (opens in a new window or tab)_CY
...
usePrintAndPostDetailed.uniformsClothingTools.1_freOnly = If you are claiming a fixed amount of tax relief, you do not need to send receipts or records._CY
...
usePrintAndPostDetailed.mileageFuel.1_freOnly = You must send a copy of your mileage log to HMRC for each job. This should show why you made each journey, with the starting and finishing postcodes._FY
usePrintAndPostDetailed.mileageFuel.2_freOnly = If your employer has not paid you back for any mileage or travel costs, you need to send a letter explaining why._CY
...
usePrintAndPostDetailed.link.label_freOnly = Start your claim_CY
