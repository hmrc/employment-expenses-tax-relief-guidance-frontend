...
registeredForSelfAssessment.accordion.guidance.wfh = Ffurflen Dreth Hunanasesiad yw cofnod o’ch incwm a’ch treuliau sy’n cael ei hanfon at CThEF ar ddiwedd pob blwyddyn dreth.
registeredForSelfAssessment.accordion.guidance1 = Mae’n rhaid i chi lenwi Ffurflen Dreth Hunanasesiad os, yn y flwyddyn dreth ddiwethaf (6 Ebrill i 5 Ebrill), roeddech yn:
registeredForSelfAssessment.accordion.guidance2 = Fel arfer, ni fydd angen i chi anfon Ffurflen Dreth os yw’ch unig incwm yn dod o’ch cyflog neu’ch pensiwn. Ond efallai y bydd angen i chi anfon un os oes gennych unrhyw incwm arall sydd heb ei drethu, fel:
...
claimingFor.homeWorking.description = Mae hyn yn cynnwys cost pethau a ddefnyddir ar gyfer eich gwaith yn unig, megis gwresogi a goleuo’r ystafell rydych yn gweithio ynddi, neu gost galwadau ffôn busnes. Mae’n rhaid i chi gadw cofnodion o’r hyn yr ydych wedi’i wario.
...
whichYearsAreYouClaimingFor.main.info.text = Gallwch hawlio rhyddhad treth ar gyfer eich treuliau am weithio gartref ar gyfer y flwyddyn dreth bresennol gan ddefnyddio’r gwasanaeth hwn ac, ar gyfer blynyddoedd blaenorol, gallwch gyflwyno hawliadau ar eich Ffurflen Dreth Hunanasesiad.
