...
registeredForSelfAssessment.accordion.guidance1 = Ffurflen Dreth Hunanasesiad yw cofnod o’ch incwm a’ch treuliau sy’n cael ei hanfon at CThEF ar ddiwedd pob blwyddyn dreth.
registeredForSelfAssessment.accordion.guidance2 = Mae’n rhaid i chi lenwi Ffurflen Dreth Hunanasesiad os, yn y flwyddyn dreth ddiwethaf (6 Ebrill i 5 Ebrill), roeddech yn:
registeredForSelfAssessment.accordion.guidance3 = Fel arfer, ni fydd angen i chi anfon Ffurflen Dreth os yw’ch unig incwm yn dod o’ch cyflog neu’ch pensiwn. Ond efallai y bydd angen i chi anfon un os oes gennych unrhyw incwm arall sydd heb ei drethu, fel:
...
useSelfAssessment.guidance = Mae’n rhaid i chi hawlio’r treuliau hyn fel rhan o’ch
useSelfAssessment.link.label =  Ffurflen Dreth Hunanasesiad

moreThanFiveJobs.title = A ydych yn hawlio ar gyfer mwy na 5 swydd wahanol?
...
usePrintAndPostDetailed.title_freOnly = Rydych yn gymwys i hawlio’r treuliau swydd hyn drwy’r post
...
usePrintAndPostDetailed.heading_freOnly = Rydych yn gymwys i hawlio’r treuliau swydd hyn drwy’r post
...
usePrintAndPostDetailed.para1_freOnly =  Cyn anfon eich hawliad, gwiriwch yr arweiniad isod ynghylch pob gwahanol fath o draul. Efallai y bydd angen i chi anfon tystiolaeth i CThEF ar gyfer rhai hawliadau. Mae’n rhaid i chi lenwi’r ffurflen a’i hanfon drwy’r post er mwyn hawlio’ch treuliau.
usePrintAndPostDetailed.para1_freOnly_pegaService = Cyn anfon eich hawliad, gwiriwch yr arweiniad isod ynghylch pob math o draul wahanol. I hawlio’r treuliau hyn, mewngofnodwch i gael mynediad at wasanaethau ar-lein CThEF.
...
usePrintAndPostDetailed.homeWorking.1_freOnly = Dim ond hawliadau a wneir ar neu ar ôl 6 Ebrill 2022 a fydd angen tystiolaeth. Gallai hyn fod yn gopi o’ch contract cyflogaeth.
...
usePrintAndPostDetailed.homeWorking.2_freOnly = Os nad yw’r wybodaeth berthnasol wedi’i nodi yn eich contract, bydd angen i chi anfon tystiolaeth arall atom sy’n dangos pam mae’n rhaid i chi weithio gartref. Er enghraifft, llythyr gan eich cyflogwr sy’n esbonio pam mae’n rhaid i chi weithio gartref.
usePrintAndPostDetailed.homeWorking.3_freOnly = Os mai eich dewis chi yw gweithio gartref, ni allwch hawlio’r draul hon.
...
usePrintAndPostDetailed.uniformsClothingTools.1_freOnly = Os ydych yn hawlio’r union swm a wariwyd gennych, bydd yn rhaid i chi anfon tystiolaeth i CThEF er mwyn hawlio rhyddhad treth.
...
usePrintAndPostDetailed.uniformsClothingTools.2_freOnly = Mae’n rhaid i chi lenwi’r ffurflen a’i hanfon drwy’r post er mwyn hawlio’ch treuliau.
usePrintAndPostDetailed.uniformsClothingTools.3_freOnly = Fodd bynnag, os ydych yn hawlio’r swm sefydlog o ryddhad treth, ni fydd angen i chi anfon derbyniadau na chofnodion.
...
usePrintAndPostDetailed.mileageFuel.1_freOnly_iform = Mae’n rhaid i chi anfon copi o’ch cofnod milltiroedd at CThEF ar gyfer pob swydd. Dylai hwn ddangos pam y gwnaethoch bob taith, a dylai nodi cod post ar gyfer dechrau a diwedd y daith.
usePrintAndPostDetailed.mileageFuel.2_freOnly_iform = Os nad yw’ch cyflogwr wedi’ch talu chi yn ôl am unrhyw filltiroedd neu gostau teithio, bydd angen i chi anfon llythyr yn esbonio pam.
...
usePrintAndPostWfhPolicyChange.post.submit.link = Hawlio rhyddhad treth ar gyfer eich treuliau swydd drwy’r post (yn agor tab newydd)
...
cannotClaimWfhRelief.heading = Nid ydych yn gymwys i hawlio
cannotClaimWfhRelief.title = Nid ydych yn gymwys i hawlio
cannotClaimWfhRelief.guidance = Ni allwch hawlio rhyddhad treth ar dreuliau y mae’ch cyflogwr wedi talu amdanynt

cannotClaimReliefSomeYears.title = Gallwch hawlio rhyddhad treth ar gyfer treuliau ar ôl 5 Ebrill {0}
cannotClaimReliefSomeYears.heading = Gallwch hawlio rhyddhad treth ar gyfer treuliau ar ôl 5 Ebrill {0}
cannotClaimReliefSomeYears.guidance = Mae’n rhaid gwneud hawliad cyn pen 4 blynedd o ddiwedd y flwyddyn dreth pan wnaethoch wario’r arian.
cannotClaimReliefSomeYears.link.label = Hawlio ar gyfer blynyddoedd treth ar ôl 5 Ebrill {0}

cannotClaimReliefTooLongAgo.title = Gallwch hawlio am dreuliau ar ôl 5 Ebrill {0}
cannotClaimReliefTooLongAgo.heading = Gallwch hawlio am dreuliau ar ôl 5 Ebrill {0}
cannotClaimReliefTooLongAgo.guidance = Gallwch ond hawlio ar gyfer y flwyddyn dreth hon (6 Ebrill {0} i 5 Ebrill {1}) a’r 4 blwyddyn dreth flaenorol.
cannotClaimReliefTooLongAgo.link.label = Darllenwch ‘Hawlio rhyddhad treth ar gyfer eich treuliau swydd’

paidTaxInRelevantYear.title = A ydych yn hawlio ar gyfer treuliau ar ôl 5 Ebrill {0}?
paidTaxInRelevantYear.heading = A ydych yn hawlio ar gyfer treuliau ar ôl 5 Ebrill {0}?
paidTaxInRelevantYear.error.required = Dewiswch ‘Iawn’ os ydych yn hawlio ar gyfer treuliau ar ôl 5 Ebrill {0}

notEntitled.title = I hawlio rhyddhad treth, mae’n rhaid eich bod wedi talu treth yn ystod y flwyddyn y gwnaethoch wario’r arian
notEntitled.heading = I hawlio rhyddhad treth, mae’n rhaid eich bod wedi talu treth yn ystod y flwyddyn y gwnaethoch wario’r arian
notEntitled.link.label = Darllenwch ‘Hawlio rhyddhad treth ar gyfer eich treuliau swydd’

notEntitledSomeYears.title = Gallwch gael rhyddhad treth ar dreuliau ar gyfer y blynyddoedd y gwnaethoch dalu treth
notEntitledSomeYears.heading = Gallwch gael rhyddhad treth ar dreuliau ar gyfer y blynyddoedd y gwnaethoch dalu treth
notEntitledSomeYears.link.label = Hawlio ar gyfer blynyddoedd pan wnaethoch dalu treth
...
claimingFor.insetText = Os ydych yn hawlio treuliau dim ond ar gyfer gwisg unffurf, dillad gwaith ac offer (treuliau cyfradd unffurf), nid oes angen i chi anfon tystiolaeth
...
claimingFor.travelExpenses.description = Mae hyn yn cynnwys yr arian a wariwyd gennych ar fwyd neu aros dros nos nad yw eich cyflogwr wedi’i dalu’n ôl. Mae’n rhaid i chi gadw cofnodion o’r hyn yr ydych wedi’i wario.
...
claimingFuel.heading = A ydych eisiau hawlio’r arian y gwnaethoch ei wario ar danwydd ar gyfer eich cerbyd cwmni?
claimingFuel.guidance = Mae tanwydd yn cynnwys trydan. Ni allwch hawlio’r canlynol:
claimingFuel.bullet1 = arian rydych yn ei wario i gyrraedd a gadael eich man gwaith arferol
claimingFuel.bullet2 = lwfans milltiroedd ar gyfer pethau fel treth ffordd, MOT ac atgyweiriadau
claimingFuel.error.required = Dewiswch ‘Iawn’ os ydych eisiau hawlio arian rydych wedi’i wario ar danwydd ar gyfer eich cerbyd cwmni

claimingMileage.title = A ydych eisiau hawlio’r gyfradd milltiroedd gymeradwy am ddefnyddio’ch cerbyd eich hunan ar gyfer gwaith?
claimingMileage.heading = A ydych eisiau hawlio’r gyfradd milltiroedd gymeradwy am ddefnyddio’ch cerbyd eich hunan ar gyfer gwaith?
claimingMileage.guidance = Ni allwch hawlio’r arian y gwnaethoch ei wario i gyrraedd a gadael eich man gwaith arferol. Mae’r gyfradd milltiroedd gymeradwy ar gyfer pethau megis:
claimingMileage.guidance2 = Gallwch ond hawlio rhyddhad treth os yw eich cyflogwr yn talu llai na’r gyfradd gymeradwy i chi, neu’n talu dim byd o gwbl.
claimingMileage.error.required = Dewiswch ‘Iawn’ os ydych eisiau hawlio’r gyfradd milltiroedd gymeradwy ar gyfer defnyddio’ch cerbyd eich hun ar gyfer gwaith
...
useCompanyCar.usingOwnCar.title = A ydych hefyd yn defnyddio cerbyd y mae’ch cyflogwr yn berchen arno neu’n ei roi ar brydles?
useCompanyCar.usingOwnCar.heading = A ydych hefyd yn defnyddio cerbyd y mae’ch cyflogwr yn berchen arno neu’n ei roi ar brydles?
useCompanyCar.usingOwnCar.error.required = Dewiswch ‘Iawn’ os ydych hefyd yn defnyddio cerbyd y mae’ch cyflogwr yn berchen arno neu’n ei roi ar brydles
useCompanyCar.notUsingOwnCar.title = A ydych yn defnyddio cerbyd y mae’ch cyflogwr yn berchen arno neu’n ei roi ar brydles?
useCompanyCar.notUsingOwnCar.heading = A ydych yn defnyddio cerbyd y mae’ch cyflogwr yn berchen arno neu’n ei roi ar brydles?
useCompanyCar.notUsingOwnCar.error.required = Dewiswch ‘Iawn’ os ydych yn defnyddio cerbyd y mae’ch cyflogwr yn berchen arno neu’n ei roi ar brydles
useCompanyCar.guidance = Gelwir hyn yn gerbyd cwmni neu gar cwmni.

useOwnCar.title = A ydych yn defnyddio cerbyd ar gyfer gwaith y gwnaethoch ei brynu neu ei roi ar brydles gyda’ch arian eich hun?
useOwnCar.heading = A ydych yn defnyddio cerbyd ar gyfer gwaith y gwnaethoch ei brynu neu ei roi ar brydles gyda’ch arian eich hun?
useOwnCar.error.required = Dewiswch ‘Iawn’ os yw’n defnyddio cerbyd y mae ei gyflogwr yn berchen arno neu’n ei roi ar brydles

cannotClaimMileageCosts.title = Ni allwch hawlio rhyddhad treth ar gyfer y treuliau hyn
cannotClaimMileageCosts.heading = Ni allwch hawlio rhyddhad treth ar gyfer y treuliau hyn
cannotClaimMileageCosts.guidance = Gallwch ond hawlio’r gyfradd milltiroedd gymeradwy os ydych yn defnyddio’ch cerbyd eich hun ar gyfer gwaith.
cannotClaimMileageCosts.link.label = Darllenwch ‘Hawlio rhyddhad treth ar gyfer eich treuliau swydd’

cannotClaimMileageFuelCosts.title = Ni allwch hawlio rhyddhad treth ar y treuliau hyn
cannotClaimMileageFuelCosts.heading = Ni allwch hawlio rhyddhad treth ar y treuliau hyn
cannotClaimMileageFuelCosts.guidance = Gallwch ond hawlio:
cannotClaimMileageFuelCosts.bullet1 = y gyfradd milltiroedd gymeradwy os ydych yn defnyddio’ch cerbyd eich hun ar gyfer gwaith
cannotClaimMileageFuelCosts.bullet2 = tanwydd, gan gynnwys trydan, os ydych yn defnyddio cerbyd cwmni
cannotClaimMileageFuelCosts.link.label = Darllenwch ‘Hawlio rhyddhad treth ar gyfer eich treuliau swydd’

cannotClaimBuyingEquipment.title = Ni allwch hawlio rhyddhad treth ar gyfer y treuliau hyn
cannotClaimBuyingEquipment.heading = Ni allwch hawlio rhyddhad treth ar gyfer y treuliau hyn
cannotClaimBuyingEquipment.guidance = Ar gyfer rhai eitemau mawr, er enghraifft cyfrifiadur, efallai y gallwch hawlio math o lwfans cyfalaf o’r enw
cannotClaimBuyingEquipment.guidance2 = Ni allwch hawlio lwfansau cyfalaf am brynu car, beic modur neu feic.
...
willNotPayTax.title =  Ni allwch hawlio’r treuliau hyn
willNotPayTax.heading =  Ni allwch hawlio’r treuliau hyn
willNotPayTax.guidance1 = Dim ond os gwnaethoch dalu treth ym mhob blwyddyn dreth yr ydych yn hawlio ar ei chyfer y gallwch hawlio’r treuliau hyn
willNotPayTax.guidance2 = Gallwch {0} o hyd ond ni chewch unrhyw dreuliau yn ôl oni bai eich bod yn talu treth.
willNotPayTax.link2 = hawlio treuliau ar gyfer y flwyddyn dreth hon (6 Ebrill {0} i 5 Ebrill {1})

willPayTax.title = A wnaethoch dalu treth ym mhob un o’r blynyddoedd rydych yn hawlio ar ei chyfer?
willPayTax.heading = A wnaethoch dalu treth ym mhob un o’r blynyddoedd rydych yn hawlio ar ei chyfer?
willPayTax.error.required = Dewiswch ‘Iawn’ os ydych wedi talu treth ym mhob un o’r blynyddoedd rydych yn hawlio ar ei chyfer

claimingForCurrentYear.title = A ydych ond yn hawlio ar gyfer y flwyddyn dreth bresennol, 2022-2023?
claimingForCurrentYear.heading = A ydych ond yn hawlio ar gyfer y flwyddyn dreth bresennol, 2022-2023?
...
saCheckDisclaimerCurrentYear.text1 = Byddwch yn cael rhyddhad treth ar gyfer eich treuliau am weithio gartref ar gyfer y flwyddyn dreth bresennol, sef {0}-{1}, os yw’r canlynol yn wir:
saCheckDisclaimerCurrentYear.list.item.1 = rydych yn gymwys ar gyfer rhyddhad treth
saCheckDisclaimerCurrentYear.list.item.2 = nid ydych wedi cyflwyno hawliad ar gyfer y flwyddyn hon yn barod
saCheckDisclaimerCurrentYear.text2 = Byddwn yn mynd ati i wirio nawr eich bod yn gymwys i hawlio rhyddhad treth ar gyfer y flwyddyn dreth bresennol.
saCheckDisclaimerCurrentYear.button.label = Derbyn ac yn eich blaen

saCheckDisclaimerAllYears.title = Gwiriwch y canlynol cyn mynd yn eich blaen
saCheckDisclaimerAllYears.heading = Gwiriwch y canlynol cyn mynd yn eich blaen
saCheckDisclaimerAllYears.text1 = Byddwch yn cael rhyddhad treth ar gyfer eich treuliau am weithio gartref yn seiliedig ar faint o wythnosau rydych wedi gweithio gartref yn y flwyddyn dreth hon, sef {0} i {1}, os yw’r canlynol yn berthnasol:
saCheckDisclaimerAllYears.list.item.1 = rydych yn gymwys ar gyfer rhyddhad treth
saCheckDisclaimerAllYears.list.item.2 = nid ydych wedi cyflwyno hawliad ar gyfer y flwyddyn hon yn barod
saCheckDisclaimerAllYears.text2 = Byddwn yn mynd ati i wirio nawr eich bod yn gymwys i hawlio rhyddhad treth ar gyfer y flwyddyn dreth bresennol.
saCheckDisclaimerAllYears.button.label = Derbyn ac yn eich blaen
saCheckDisclaimerAllYears.warning.text = Ni fyddwch yn cael rhyddhad treth ar gyfer blynyddoedd blaenorol wrth ddefnyddio’r gwasanaeth hwn. Bydd angen i chi hawlio ar gyfer blynyddoedd blaenorol ar eich Ffurflen Dreth Hunanasesiad.
...
disclaimer.guidance.header = Mae’r arweiniad wedi newid ers 6 Ebrill 2022
disclaimer.guidance.summary = Mae’r arweiniad ynghylch hawlio rhyddhad treth am weithio gartref wedi newid ar gyfer treuliau sy’n codi ar neu ar ôl 6 Ebrill 2022.
disclaimer.guidance.summary_freOnly = Mae’r arweiniad ynghylch hawlio treuliau gweithio gartref ar gyfer blynyddoedd treth ar neu ar ôl 6 Ebrill 2022 wedi newid.
disclaimer.claim.after.h2 = Hawlio rhyddhad treth ar neu ar ôl 6 Ebrill 2022
disclaimer.claim.after.insetText = Mae’n rhaid i chi anfon tystiolaeth i CThEF i ddangos pam rydych yn cael rhyddhad treth. Mae’n rhaid i chi argraffu ac anfon ffurflen wedi’i llenwi i CThEF i hawlio ar eich treuliau.
disclaimer.claim.after.p1 = Gallwch hawlio os nad yw’ch cyflogwr eisoes wedi talu’ch treuliau a’ch bod wedi mynd i gostau ychwanegol ar eich aelwyd o ganlyniad i weithio gartref.
disclaimer.claim.after.p2 = Mae’n rhaid i un o’r rheolau canlynol fod yn berthnasol hefyd:
disclaimer.claim.after.l1 = nid oes cyfleusterau priodol ar gael i chi gyflawni’ch swydd ar safle’ch cyflogwr
disclaimer.claim.after.l2 = mae’ch swydd yn gofyn i chi deithio pellter afresymol i safle’ch cyflogwr ac oddi yno’n ddyddiol
disclaimer.claim.after.l3 = mae’n ofynnol i chi, o dan gyfyngiadau’r llywodraeth, weithio gartref
disclaimer.claim.p1 = Ni allwch hawlio rhyddhad treth os mai’r cyfan a wnaethoch oedd dewis gweithio gartref.
disclaimer.claim.before.h2 = Hawlio rhyddhad treth ar neu cyn 5 Ebrill 2022
disclaimer.claim.before.insetText = Os ydych yn gweithio gartref oherwydd canllawiau’r llywodraeth, nid oes angen i chi roi tystiolaeth o hyn.
disclaimer.claim.before.p1 = Gallwch wneud hawliad os yw pob un o’r rheolau canlynol yn berthnasol:
...
informCustomerClaimNowInWeeks.title_freOnly = Mae hawliadau a wneir ar gyfer blynyddoedd treth ar neu ar ôl 6 Ebrill 2023 bellach yn cael eu cyfrifo mewn wythnosau
informCustomerClaimNowInWeeks.title = Bydd hawliadau ar neu ar ôl 6 Ebrill 2023 yn cael eu cyfrifo mewn wythnosau
informCustomerClaimNowInWeeks.heading = Bydd hawliadau ar neu ar ôl 6 Ebrill 2023 yn cael eu cyfrifo mewn wythnosau
informCustomerClaimNowInWeeks.heading_freOnly = Mae hawliadau a wneir ar gyfer blynyddoedd treth ar neu ar ôl 6 Ebrill 2023 bellach yn cael eu cyfrifo mewn wythnosau
