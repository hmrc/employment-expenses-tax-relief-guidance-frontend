...
class ClaimTypeViewSpec extends YesNoViewBehaviours {

  val messageKeyPrefix = "claimType"
  ...
  "ClaimType view" must {
    ...
    behave like yesNoPage(createView, messageKeyPrefix, routes.ClaimTypeController.onSubmit().url)
