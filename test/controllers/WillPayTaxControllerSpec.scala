...
class WillPayTaxControllerSpec extends ControllerSpecBase {
  ...
  def viewAsString(form: Form[_] = form) = willPayTax(frontendAppConfig, form)(fakeRequest, messages).toString
  ...
  "WillPayTax Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      val validData = Map(WillPayTaxId.toString -> JsBoolean(true))
